  ...
  return (
    <DashboardLayout title="Business Dashboard" navItems={navItems}>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <Button className="gradient-navy text-primary-foreground font-semibold" onClick={() => setIssueModalOpen(true)}>
      ...
      <IssueTokenModal open={issueModalOpen} onOpenChange={setIssueModalOpen} />
    </DashboardLayout>
  );
};
