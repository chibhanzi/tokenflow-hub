...
const businessesData: Record<string, {
  ...
  "nala-logistics": {
    ...
    highlights: [
      "Fleet of 120+ vehicles across 3 countries",
      "Partnered with Kenya's Ministry of Agriculture",
      "30% revenue growth year-over-year since 2021",
      "ISO 9001:2015 certified operations",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$340K" }, { period: "Q2 2025", amount: "$365K" },
      { period: "Q3 2025", amount: "$390K" }, { period: "Q4 2025", amount: "$420K" },
    ],
  },
  "mombasa-farms": {
    ...
    description: "Mombasa Farms operates large-scale sustainable agriculture across coastal Kenya. Their specialties include tropical fruit exports, organic vegetables, and aquaculture. They supply to major supermarket chains and export to the Middle East and Europe.",
    ceo: "David Mwangi", totalRaised: "$800K", tokensSold: 700, totalTokens: 1000,
    highlights: [
      "500+ hectares of certified organic farmland",
      "Export contracts with 12 international buyers",
      "Pioneering drip irrigation technology in the region",
      "Employs 120+ full-time workers from local communities",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$240K" }, { period: "Q2 2025", amount: "$255K" },
      { period: "Q3 2025", amount: "$260K" }, { period: "Q4 2025", amount: "$280K" },
    ],
  },
  "techhub-lagos": {
    ...
    description: "TechHub Lagos is a fast-growing SaaS company building fintech infrastructure for African businesses. Their API suite enables payments, lending, and KYC across 8 West African countries, processing over $50M in transactions monthly.",
    ceo: "Chidi Okonkwo", totalRaised: "$2.5M", tokensSold: 3000, totalTokens: 4000,
    highlights: [
      "Processing $50M+ monthly transactions",
      "API integrations with 15 major banks",
      "Y Combinator alumni (W2022 batch)",
      "45% quarter-over-quarter growth rate",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$480K" }, { period: "Q2 2025", amount: "$560K" },
      { period: "Q3 2025", amount: "$680K" }, { period: "Q4 2025", amount: "$800K" },
    ],
  },
  "zanzibar-tours": {
    ...
    description: "Zanzibar Tours is a premium eco-tourism operator offering curated experiences across Zanzibar and mainland Tanzania. They run boutique lodges, guided safaris, and marine excursions, serving over 15,000 tourists annually.",
    ceo: "Fatima Hassan", totalRaised: "$600K", tokensSold: 600, totalTokens: 1000,
    highlights: [
      "TripAdvisor Travelers' Choice 2024 & 2025",
      "3 boutique eco-lodges with 95% occupancy rate",
      "Carbon-neutral certified operations",
      "Partnership with Tanzania National Parks Authority",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$160K" }, { period: "Q2 2025", amount: "$195K" },
      { period: "Q3 2025", amount: "$210K" }, { period: "Q4 2025", amount: "$230K" },
    ],
  },
  "cape-solar": {
    ...
    description: "Cape Solar designs and installs commercial solar energy systems across Southern Africa. They manage a portfolio of 40MW installed capacity and offer power purchase agreements to businesses looking to reduce energy costs.",
    ceo: "Pieter van der Merwe", totalRaised: "$3.1M", tokensSold: 2200, totalTokens: 3000,
    highlights: [
      "40MW+ installed solar capacity",
      "Serving 150+ commercial clients",
      "Backed by Development Finance Corporation",
      "Lowest risk rating on the DePeer platform",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$410K" }, { period: "Q2 2025", amount: "$440K" },
      { period: "Q3 2025", amount: "$470K" }, { period: "Q4 2025", amount: "$500K" },
    ],
  },
  "accra-fintech": {
    ...
    description: "Accra Fintech provides mobile money and micro-lending services across Ghana and Côte d'Ivoire. Their platform has onboarded over 500,000 users and disbursed $12M in micro-loans with a 96% repayment rate.",
    ceo: "Kwame Asante", totalRaised: "$1.8M", tokensSold: 1400, totalTokens: 2000,
    highlights: [
      "500,000+ registered users across 2 countries",
      "96% loan repayment rate",
      "Licensed by Bank of Ghana",
      "Fastest growing fintech in West Africa (TechCabal 2025)",
    ],
    revenueHistory: [
      { period: "Q1 2025", amount: "$680K" }, { period: "Q2 2025", amount: "$800K" },
      { period: "Q3 2025", amount: "$950K" }, { period: "Q4 2025", amount: "$1.1M" },
    ],
  },
};
        ...
        <div className="flex gap-2 shrink-0">
          <Button variant="outline" size="sm" asChild>
            <a href={company.website} target="_blank" rel="noopener noreferrer">
              <Globe size={14} className="mr-1" /> Visit Website <ExternalLink size={12} className="ml-1" />
            </a>
          </Button>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-lg bg-muted/50 p-3">
                ...
                <div className="font-display font-bold text-lg text-[hsl(var(--success))]">{company.growth}</div>
              </div>
              <div className="rounded-lg bg-muted/50 p-3">
          ...
          <CardContent>
            <div className="space-y-3">
              {company.revenueHistory.map((r) => (
                <div key={r.period} className="flex items-center justify-between text-sm border-b border-border/50 pb-2 last:border-0">
